...
namespace Taxi
{
    public partial class F4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < автомобилиDataGridView.ColumnCount - 1; i++)
            {
                for (int j = 0; j < автомобилиDataGridView.RowCount - 1; j++)
                {
                    автомобилиDataGridView[i, j].Style.BackColor = Color.White;
                    автомобилиDataGridView[i, j].Style.ForeColor = Color.Black;
                }
            }
            ...
            for (int i = 0; i < автомобилиDataGridView.ColumnCount - 1; i++)
            {
                for (int j = 0; j < автомобилиDataGridView.RowCount - 1; j++)
                {
                    if (автомобилиDataGridView[i, j].Value.ToString().IndexOf(textBox1.Text) != -1)
                    {
                        автомобилиDataGridView[i, j].Style.BackColor = Color.AliceBlue;
                        автомобилиDataGridView[i, j].Style.ForeColor = Color.Blue;
                    }
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked) автомобилиDataGridView.Sort(COL, System.ComponentModel.ListSortDirection.Ascending);
            else автомобилиDataGridView.Sort(COL, System.ComponentModel.ListSortDirection.Descending);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            автомобилиBindingSource.Filter = "Год выпуска='" + comboBox1.Text + "'";
        }
